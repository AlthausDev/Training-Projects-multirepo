 ...
 * @author samuelaa
 */
public class ComponenteEjemploBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_listenerList = 78;
    ...
    private static final int PROPERTY_numCaracteres = 96;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getAccessibleContext", "setAccessibleContext" ); // NOI18N
            properties[PROPERTY_action] = new PropertyDescriptor ( "action", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getAction", "setAction" ); // NOI18N
            properties[PROPERTY_actionCommand] = new PropertyDescriptor ( "actionCommand", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, null, "setActionCommand" ); // NOI18N
            properties[PROPERTY_actionListeners] = new PropertyDescriptor ( "actionListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getActionListeners", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_actions] = new PropertyDescriptor ( "actions", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getActions", null ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_caret] = new PropertyDescriptor ( "caret", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getCaret", "setCaret" ); // NOI18N
            properties[PROPERTY_caretColor] = new PropertyDescriptor ( "caretColor", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getCaretColor", "setCaretColor" ); // NOI18N
            properties[PROPERTY_caretListeners] = new PropertyDescriptor ( "caretListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getCaretListeners", null ); // NOI18N
            properties[PROPERTY_caretPosition] = new PropertyDescriptor ( "caretPosition", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getCaretPosition", "setCaretPosition" ); // NOI18N
            properties[PROPERTY_colores] = new PropertyDescriptor ( "colores", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getColores", "setColores" ); // NOI18N
            properties[PROPERTY_colores].setPropertyEditorClass ( pa.althaus.dam.vitp.components.ColoresPropertiesEditorSuport.class );
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_columns] = new PropertyDescriptor ( "columns", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getColumns", "setColumns" ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_disabledTextColor] = new PropertyDescriptor ( "disabledTextColor", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getDisabledTextColor", "setDisabledTextColor" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_document] = new PropertyDescriptor ( "document", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getDocument", "setDocument" ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dragEnabled] = new PropertyDescriptor ( "dragEnabled", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getDragEnabled", "setDragEnabled" ); // NOI18N
            properties[PROPERTY_dropLocation] = new PropertyDescriptor ( "dropLocation", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getDropLocation", null ); // NOI18N
            properties[PROPERTY_dropMode] = new PropertyDescriptor ( "dropMode", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getDropMode", "setDropMode" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_editable] = new PropertyDescriptor ( "editable", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isEditable", "setEditable" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusAccelerator] = new PropertyDescriptor ( "focusAccelerator", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getFocusAccelerator", "setFocusAccelerator" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_highlighter] = new PropertyDescriptor ( "highlighter", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getHighlighter", "setHighlighter" ); // NOI18N
            properties[PROPERTY_horizontalAlignment] = new PropertyDescriptor ( "horizontalAlignment", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getHorizontalAlignment", "setHorizontalAlignment" ); // NOI18N
            properties[PROPERTY_horizontalVisibility] = new PropertyDescriptor ( "horizontalVisibility", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getHorizontalVisibility", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_keymap] = new PropertyDescriptor ( "keymap", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getKeymap", "setKeymap" ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_listenerList] = new PropertyDescriptor ( "listenerList", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getListenerList", "setListenerList" ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_margin] = new PropertyDescriptor ( "margin", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getMargin", "setMargin" ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mixingCutoutShape] = new PropertyDescriptor ( "mixingCutoutShape", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, null, "setMixingCutoutShape" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_navigationFilter] = new PropertyDescriptor ( "navigationFilter", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getNavigationFilter", "setNavigationFilter" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_numCaracteres] = new PropertyDescriptor ( "numCaracteres", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getNumCaracteres", "setNumCaracteres" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getParent", null ); // NOI18N
            properties[PROPERTY_preferredScrollableViewportSize] = new PropertyDescriptor ( "preferredScrollableViewportSize", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getPreferredScrollableViewportSize", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_scrollableTracksViewportHeight] = new PropertyDescriptor ( "scrollableTracksViewportHeight", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getScrollableTracksViewportHeight", null ); // NOI18N
            properties[PROPERTY_scrollableTracksViewportWidth] = new PropertyDescriptor ( "scrollableTracksViewportWidth", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getScrollableTracksViewportWidth", null ); // NOI18N
            properties[PROPERTY_scrollOffset] = new PropertyDescriptor ( "scrollOffset", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getScrollOffset", "setScrollOffset" ); // NOI18N
            properties[PROPERTY_selectedText] = new PropertyDescriptor ( "selectedText", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getSelectedText", null ); // NOI18N
            properties[PROPERTY_selectedTextColor] = new PropertyDescriptor ( "selectedTextColor", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getSelectedTextColor", "setSelectedTextColor" ); // NOI18N
            properties[PROPERTY_selectionColor] = new PropertyDescriptor ( "selectionColor", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getSelectionColor", "setSelectionColor" ); // NOI18N
            properties[PROPERTY_selectionEnd] = new PropertyDescriptor ( "selectionEnd", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getSelectionEnd", "setSelectionEnd" ); // NOI18N
            properties[PROPERTY_selectionStart] = new PropertyDescriptor ( "selectionStart", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getSelectionStart", "setSelectionStart" ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_text] = new PropertyDescriptor ( "text", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getText", "setText" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_actionListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "actionListener", java.awt.event.ActionListener.class, new String[] {"actionPerformed"}, "addActionListener", "removeActionListener" ); // NOI18N
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_caretListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "caretListener", javax.swing.event.CaretListener.class, new String[] {"caretUpdate"}, "addCaretListener", "removeCaretListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( pa.althaus.dam.vitp.components.ComponenteEjemplo.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
