...
import pa.althaus.dam.javaproyect.aeropuerto.model.Municipio;
...
public class DatosAirlinesView extends javax.swing.JPanel {
    ...
    private void fillMunicipios() {
        MunicipiosCsvReader csvReader = new MunicipiosCsvReader();        
        HashMap<String, String> municipios = csvReader.readMunicipiosCSV();    
        municipios.forEach((codigo, nombre) -> cbMunicipio.addItem(nombre));
}
